    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between space-y-4">
            <section className="flex flex-col w-full p-8 space-y-20">
                <h2 className="  font-bold tracking-wide text-secondary text-5xl md:text-6xl">Stáhněte si e-book</h2>
                ...
                <div className="w-full md:w-4/5 flex flex-col space-y-2 p-5 bg-secondary/90 rounded-xl text-primary mx-auto">
