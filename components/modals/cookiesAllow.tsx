...
export default function CookiesBanner() {
    ...
    <div className="flex flex-row items-center space-x-2">
      <Checkbox id="personal" className='border-white' name="personal"/>
      <label
        htmlFor="personal"
    ...
    <div className="flex flex-row items-center space-x-2">
      <Checkbox className='border-white' id="provoz" name="provoz" checked/>
      <label
        htmlFor="provoz"
    ...
    <div className="flex flex-row items-center space-x-2">
    <Checkbox id="analytics" className='border-white' name="analytics" />
      <label
        htmlFor="analytics"
    ...
    <Button variant={"secondary"} name='submit'>{isPending ? <Loader2 className='animate-spin' /> : <>Odeslat</>}</Button>
                    </form>
                    </div>
                </div>
            </div>
